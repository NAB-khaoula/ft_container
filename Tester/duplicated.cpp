...
int main(){
	...
	// ft::vector<data>::iterator it(Data.begin());
	// std::cout << it->a << std::endl;
	// it = Data.end();
	// std::cout << it->a << std::endl;
	// ft::vector<data>::reverse_iterator it2(Data.rbegin());
	// std::cout << it2->a << std::endl;
	// ft::vector<data>::reverse_iterator it3(Data.begin());
	// std::cout << it3->a << std::endl;
	// it2 = Data.rend();
	// std::cout << it2->a << std::endl;
	// ft::vector<data>::reverse_iterator it4(Data.end());
	// std::cout << it4->a << std::endl;
	ft::vector<data> emptyData;
	// ft::vector<data>::reverse_iterator emptyDataRevIt(emptyData.rbegin());
